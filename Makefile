...
$(TARGET_LINUX_RELEASE): $(OBJS_LINUX_RELEASE)
	...
	$(CXX_LINUX) $(CXXFLAGS_LINUX_RELEASE) -o $@ $^ $(LIB_DIRS_LINUX_RELEASE) $(LIBS_LINUX_RELEASE)

$(OBJ_DIR)/Linux/x86_64/Release/%.o: $(SRC_DIR)/%.cpp
	@mkdir -p $(OBJ_DIR)/Linux/x86_64/Release
	$(CXX_LINUX) $(CXXFLAGS_LINUX_RELEASE) $(PREPROCESSOR_DEFINITIONS_LINUX_RELEASE) $(INCLUDE_DIRS_LINUX_RELEASE) -MMD -MP -c $< -o $@
...
$(TARGET_LINUX_DEBUG): $(OBJS_LINUX_DEBUG)
	...
	$(CXX_LINUX) $(CXXFLAGS_LINUX_DEBUG) -o $@ $^ $(LIB_DIRS_LINUX_DEBUG) $(LIBS_LINUX_DEBUG)

$(OBJ_DIR)/Linux/x86_64/Debug/%.o: $(SRC_DIR)/%.cpp
	@mkdir -p $(OBJ_DIR)/Linux/x86_64/Debug
	$(CXX_LINUX) $(CXXFLAGS_LINUX_DEBUG) $(PREPROCESSOR_DEFINITIONS_LINUX_DEBUG) $(INCLUDE_DIRS_LINUX_DEBUG) -MMD -MP -c $< -o $@
...
$(TARGET_WINDOWS_RELEASE): $(OBJS_WINDOWS_RELEASE)
	...
	$(CXX_WINDOWS) $(CXXFLAGS_WINDOWS_RELEASE) -o $@ $^ $(LIB_DIRS_WINDOWS_RELEASE) $(LIBS_WINDOWS_RELEASE)

$(OBJ_DIR)/Windows/x86_64/Release/%.o: $(SRC_DIR)/%.cpp
	@mkdir -p $(OBJ_DIR)/Windows/x86_64/Release
	$(CXX_WINDOWS) $(CXXFLAGS_WINDOWS_RELEASE) $(PREPROCESSOR_DEFINITIONS_WINDOWS_RELEASE) $(INCLUDE_DIRS_WINDOWS_RELEASE) -MMD -MP -c $< -o $@
...
$(TARGET_WINDOWS_DEBUG): $(OBJS_WINDOWS_DEBUG)
	...
	$(CXX_WINDOWS) $(CXXFLAGS_WINDOWS_DEBUG) -o $@ $^ $(LIB_DIRS_WINDOWS_DEBUG) $(LIBS_WINDOWS_DEBUG)

$(OBJ_DIR)/Windows/x86_64/Debug/%.o: $(SRC_DIR)/%.cpp
	@mkdir -p $(OBJ_DIR)/Windows/x86_64/Debug
	$(CXX_WINDOWS) $(CXXFLAGS_WINDOWS_DEBUG) $(PREPROCESSOR_DEFINITIONS_WINDOWS_DEBUG) $(INCLUDE_DIRS_WINDOWS_DEBUG) -MMD -MP -c $< -o $@
